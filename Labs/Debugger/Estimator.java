...
/**
 * If we lined up passenger busses nose to nose from Harrisonburg to
 * Washington DC, then we filled each bus with golf balls, how many balls would
...
public class Estimator
{
    ...
    public static void main(String[] args)
    {
        ...
        int hoursToDC = 3;
        int numBusses = estimateNumBusses(hoursToDC, numSeatsInBus);
     ...
     */
    public static long numGolfballsInBus(int seats)
    {
        ...
        return (long) (busFreeVolume/ ballVolume);
    }
    ...
    public static double freeVolume(int volume, int percentOccupied)
    {
        ...
        freeVolume = volume * (percentFree / 100.0);
        return freeVolume;
